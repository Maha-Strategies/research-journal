...
export const WORKING_PAPERS: Record<string, WorkingPaper> = {
  ...
  'de_sitter_swampland_map': { slug: 'de_sitter_swampland_map', title: 'The de Sitter Problem in the String Swampland: A Verified Literature Map', version: '2.0', versionDate: '2026-07-26', status: 'Preprint', statusDetail: 'Verified literature map and orientation tool', reviewStatus: nonPeerReviewed, versionHistory: [{ version: '1.0.0', date: '2026-06-10', note: 'Initial public literature-map edition.' }, { version: '2.0', date: '2026-07-26', note: 'Published Zenodo edition; completed the citation-verification ledger, final human read, and full journal references.' }] },
